...
![展示 RNN 生成单词 'HELLO' 的示例图片。](../../../../../lessons/5-NLP/17-GenerativeNetworks/images/rnn-generate.png)

在生成文本（推理阶段）时，我们从某个**提示**开始，将其传递给 RNN 单元以生成中间状态，然后从该状态开始生成。我们一次生成一个字符，并将状态和生成的字符传递给另一个 RNN 单元以生成下一个字符，直到生成足够的字符。

<img src="../../../../../lessons/5-NLP/17-GenerativeNetworks/images/rnn-generate-inf.png" width="60%"/>
